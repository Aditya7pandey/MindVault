...
export default function VerifyPage() {
    ...
    const { verifyEmail, isAuthenticated } = useStore();
    ...
    useEffect(() => {
        ...
        if (!userId) {
            // Redirect to signup if no userId is present (direct access protection)
            navigate('/auth');
        }
        ...
        <div className="min-h-screen bg-[#030303] text-white font-sans selection:bg-indigo-500/30 overflow-hidden flex items-center justify-center p-6">
            ...
            >
                ...
                <div className="flex flex-col items-center mb-12">
                    ...
                    <p className="text-gray-500 mt-2 font-medium">We sent a code to {email || 'your email'}</p>
                </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <Input
                                    ...
                                    placeholder="123456"
                                    className="h-12 pl-12 bg-white/5 border-white/10 rounded-xl focus:ring-indigo-500 tracking-widest text-lg"
                                    maxLength={6}
                                    required
                                />
                            </div>
